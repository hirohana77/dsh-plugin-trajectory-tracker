window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = [
			...
			".dsh-tt-row[data-hint]:hover::after{content:attr(data-hint);position:absolute;left:4px;bottom:calc(100% + 4px);background:#0f172a !important;color:#ffffff !important;border:1px solid rgba(255,255,255,.2) !important;padding:4px 8px;border-radius:6px;font-size:11px;font-weight:500;line-height:16px;white-space:nowrap;max-width:340px;overflow:hidden;text-overflow:ellipsis;box-shadow:0 8px 20px rgba(0,0,0,.5);pointer-events:none;z-index:1200}",
