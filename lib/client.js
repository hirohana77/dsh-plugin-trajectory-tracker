window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = [
			...
			".dsh-tt-rows{display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto;min-width:240px;position:relative}",
			".dsh-tt-row{display:flex;justify-content:space-between;align-items:center;gap:16px;font-size:12px;line-height:18px;color:var(--dsw-alias-label-secondary);position:relative;cursor:default;border-radius:4px;padding:2px 6px;margin:0 -6px;transition:background .15s}",
			".dsh-tt-row:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.06))}",
			".dsh-tt-row[data-hint]:hover::after{content:attr(data-hint);position:absolute;left:4px;bottom:calc(100% + 4px);background:var(--dsw-specific-popover,#111827);color:var(--dsw-alias-label-primary,#f8fafc);border:1px solid var(--dsw-alias-border-subtle,rgba(255,255,255,.15));padding:4px 8px;border-radius:6px;font-size:11px;line-height:16px;white-space:nowrap;max-width:320px;overflow:hidden;text-overflow:ellipsis;box-shadow:0 8px 16px rgba(0,0,0,.4);pointer-events:none;z-index:1200}",
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: items.map((item, idx) => (0, react_jsx_runtime.jsxs)("div", {
							...
							"data-hint": item.highlight || void 0,
							title: item.highlight || void 0,
							children: [
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					showClock ? (0, react_jsx_runtime.jsx)("span", {
						...
						"aria-hidden": true,
						children: live.elapsedMs < 60e3 ? `(${(live.elapsedMs / 1000).toFixed(1)}s)` : `(${formatRunDuration(live.elapsedMs)})`
					}) : null
				]
			});
		}
